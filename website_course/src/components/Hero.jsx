      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-2xl animate-fade-slide-up">
            ...
            <p className="text-lg text-text-secondary mb-10 leading-[1.6] max-w-lg border-l-2 border-brand-violet pl-6">
          ...
          <div className="relative hidden lg:block animate-fade-slide-up" style={{ animationDelay: '150ms' }}>
            <div className="relative z-10 w-full aspect-square rounded-3xl overflow-hidden border border-border-default shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 right-8 glass-panel p-5 rounded-2xl flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-text-primary">Sertifikat Resmi Terakreditasi</p>
                </div>
              </div>
            </div>
